...
- **Optional verified rankings:** play without an account, or voluntarily submit a replay through your GitHub identity. Transparent scoring combines progress, exploration, normalized time and surviving lives. The landing page shows only the current weekly Top 3; rankings restart every Monday while champions enter the Hall of Fame and permanent All-Time table. [How rankings, scoring and owner moderation work](docs/rankings.md).
